...
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax  # 长度为6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>  # 起跳
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx  # 再跳到这
  ...
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi # 第一个参数
  ...
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax  # %eax=0  # 跳到这
...
00000000004010f4 <phase_6>:
  ...
  401103:	48 89 e6             	mov    %rsp,%rsi  # 输入第二个参数
  ...
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)  # 与上一个数不能相同
